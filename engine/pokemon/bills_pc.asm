...
PCString_WhatsUp: db "Scegli un'opzione.@"
PCString_ReleasePKMN: db "Liberare <PK><MN>?@"
PCString_MoveToWhere: db "Dove spostarlo?@"
PCString_ItsYourLastPKMN: db "È l'ultimo <PK><MN>!@"
PCString_TheresNoRoom: db "Non c'è posto!@"
PCString_NoMoreUsablePKMN: db "Non hai <PK><MN> utili!@"
PCString_RemoveMail: db "Rimuovi MESS.@"
PCString_ReleasedPKMN: db "Liberato <PK><MN>.@"
PCString_Bye: db "Ciao,@"
PCString_Stored: db "Posato @"
PCString_Got: db "Preso @"
PCString_Non: db "Nessuno.@"
PCString_BoxFull: db "BOX pieno.@"
PCString_PartyFull: db "Squadra completa!@"
PCString_NoReleasingEGGS: db "Imposs.liber.UOVA.@"
