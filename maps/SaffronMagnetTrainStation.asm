...
SaffronMagnetTrainStationGymGuyText:
	text "Il SUPERTRENO è"
	line "un modernissimo"

	para "mezzo di trasporto"
	line "che con l'elet-"
	cont "tricità e la forza"
	cont "magnetica raggiun-"
	cont "ge incredibili"
	cont "velocità."
...
SaffronMagnetTrainStationGymGuyText_ReturnedMachinePart:
	...
	para "Quanti viaggi avrò"
	line "già fatto avanti e"

	para "indietro tra KANTO"
	line "e JOHTO?"
	done

SaffronMagnetTrainStationTeacherText:
	text "La STAZIONE del"
	line "SUPERTRENO è"

	para "stata costruita al"
	line "posto di una casa."

	para "Ci viveva una"
	line "ragazzina di nome"
	cont "COPIONA."
	done

SaffronMagnetTrainStationLassText:
	text "Ciao, hai"
	line "l'ABBONAMENTO? Io"

	para "sì. Tutti quelli"
	line "di ZAFFERANOPOLI"
