...
HikerAnthony2SeenText:
	text "Ho attraversato il"
	line "tunnel, ma ho"

	para "ancora parecchia"
	line "energia."
	done

HikerAnthony2BeatenText:
	text "Tu hai ancora più"
	line "energia di me!"
	done

HikerAnthony2AfterText:
	text "Noi AVVENTURIERI"
	line "rendiamo al"
	cont "meglio sui monti."
	done
...
HikerAnthonyDunsparceText:
	...
	para "Ne ho uno anch'io."

	para "Guardalo! Se lo"
	line "osservi alla luce"
	cont "ha un muso davvero"
	cont "buffo!"
	done
...
Route33LassText:
	...
	para "Finalmente sono"
	line "fuori!"

	para "La grotta era più"
	line "grande di quanto"
	cont "pensassi!"

	para "Ero troppo stanca"
	line "per esplorarla"

	para "tutta, così sono"
	line "uscita."
	done
