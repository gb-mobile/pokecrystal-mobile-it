...
CameraGrunt2BeatenText:
	text "Nelle statue dei"
	line "#MON ci sono"
	cont "delle telecamere"
	cont "di sicurezza."

	para "Finché non"
	line "disattivi un in-"
	cont "terruttore segreto"
	cont "appariranno sempre"
	cont "nuove guardie."
	done

ScientistJedSeenText:
	text "Un tempo questo"
	line "era un covo ninja."
...
ScientistJedAfterBattleText:
	...
	cont "pavimento un"
	cont "pannello di"
	cont "teletrasferimento."

	para "Chi ci va sopra"
	line "è catapultato"
...
GruntM16SeenText:
	...
	para "Prova a fare un"
	line "altro passo."

	para "Il pavimento è"
	line "pieno di trappole!"
	done
...
GruntM16AfterBattleText:
	text "Non so dove siano"
	line "state posizionate"
	cont "le trappole."

	para "Devi solo armarti"
	line "di coraggio"
	cont "e camminare."
	done

TeamRocketBaseB1FSecurityCameraText:
	text "È la statua di un"
	line "PERSIAN…"

	para "Gli occhi brillano"
	line "sinistramente."
	done

TeamRocketBaseB1FSecretSwitchText:
	text "Un interruttore"
	line "segreto. È meglio"
	cont "premerlo."
	done
