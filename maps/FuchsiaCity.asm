...
FuchsiaCityPokefanMText:
	text "La figlia di KOGA"
	line "ha preso il suo"

	para "posto dopo che il"
	line "padre è entrato"
	cont "nei SUPERQUATTRO."
	done
...
SafariZoneClosedSignText:
	text "Il GUARDIANO si"
	line "trova all'estero."
...
NoLitteringSignText:
	text "Vietato gettare"
	line "rifiuti."

	para "Riportate a casa"
	line "la spazzatura."
	done
