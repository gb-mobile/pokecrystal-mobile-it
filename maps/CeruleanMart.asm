...
CeruleanMart_CooltrainerMText:
	text "Troverai parecchi"
	line "allenatori verso"

	para "il PROMONTORIO di"
	line "CELESTOPOLI."

	para "Vogliono vedere"
	line "come se la cavano"
...
CeruleanMart_CooltrainerFText:
	text "MISTY è l'unica in"
	line "città che possa"

	para "battere gli alle-"
	line "natori del"
	cont "PROMONTORIO."
	done
