...
Route34IlexForestGateTeacher_ForestIsRestless:
	text "Al BOSCO DI LECCI"
	line "c'è qualcosa che"
	cont "non va…"

	para "Stai alla larga, è"
	line "meglio."
	done
...
Route34IlexForestGateLassText:
	text "Hai visto il"
	line "santuario dedicato"
	cont "al protettore del"
	cont "BOSCO DI LECCI?"

	para "Vigila sul BOSCO"
	line "attraverso il"
	cont "tempo."
