...
CatchingTutorialBoxFullText:
	text "I #MON sono na-"
	line "scosti nell'erba."

	para "Chissà quando ver-"
	line "ranno fuori…"
	done

CatchingTutorialIntroText:
	text "Non è la prima"
	line "volta che ti vedo:"

	para "quanti #MON"
	line "hai catturato?"

	para "Vuoi che ti mostri"
	line "come catturare i"
	cont "#MON?"
	done
...
CatchingTutorialRepeatText:
	text "Ehi, vuoi che ti"
	line "mostri come cat-"
	cont "turare i #MON?"
	done

Route29YoungsterText:
	text "Dimmi, come stanno"
	line "i tuoi #MON?"

	para "Se sono deboli e"
	line "non pronti per la"

	para "lotta, stai di-"
	line "stante dall'erba."
	done
