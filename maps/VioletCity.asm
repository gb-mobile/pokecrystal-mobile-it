...
Text_VeryNiceIndeed:
	text "Oh, la la! Rimango"
	line "senza fiato!"
	done

Text_FollowEarl:
	text "Davvero? Ma non"
	line "hai ancora studia-"
	cont "to! Seguimi!"
	done

Text_HereTeacherIAm:
	text "Sono insegnante,"
	line "non te l'ho detto?"
	cont "Vuoi imparare da"
	cont "me qualche"
	cont "trucchetto?"
	done
...
VioletCitySuperNerdText:
	...
	para "CAPOPALESTRA sarà"
	line "la tua prova per"
...
VioletCityGrampsText:
	...
	line "palestra del padre"

	para "e la sta mandando"
	line "avanti molto bene."
	done
