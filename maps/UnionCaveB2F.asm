...
CooltrainermNickSeenText:
	text "Ci sono due tipi"
	line "di persone."

	para "Chi ha stile e"
	line "chi non ne ha."

	para "Tu a quale tipo"
	line "appartieni?"
	done
...
CooltrainermNickAfterBattleText:
	text "Ci sai fare con i"
	line "#MON, non c'è"
	cont "dubbio."

	para "Sicuramente farai"
	line "sempre meglio!"
	done

CooltrainerfGwenSeenText:
	text "Mi sto allenando."
	line "Lottiamo un po'?"
	done

CooltrainerfGwenBeatenText:
	text "Oh no! Sei troppo"
	line "forte per me!"
	done

CooltrainerfGwenAfterBattleText:
	text "Mi allenerò finché"
	line "non avrò fatto"
	cont "progressi."
	done

CooltrainerfEmmaSeenText:
	text "Andrei ovunque per"
	line "trovare i #MON"
	cont "che mi piacciono."

	para "È questo che deve"
	line "fare un vero"
	cont "allenatore."
	done
...
CooltrainerfEmmaAfterBattleText:
	text "Una volta alla"
	line "settimana un #-"
	cont "MON si avvicina al"
	cont "bordo dell'acqua."
