...
BurnedTowerB1FEusineText:
	text "EUGENIUS: Ho"
	line "scavato un buco e…"

	para "…sai cos'ho visto?"

	para "Ho visto SUICUNE"
	line "correre come un"

	para "fulmine, proprio"
	line "davanti a me!"

	para "L'ho cercato per"
	line "dieci anni, e"
	...
	para "AMARANTOPOLI"
	line "mettano alla prova"

	para "alcuni umani, per"
	line "farli avvicinare."

	para "Continuerò a"
	line "seguire SUICUNE."

	para "<PLAYER>, spero di"
	line "rivederti!"
